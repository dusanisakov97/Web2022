...
public class KorisnikServis {
	...
	public Response registruj(Korisnik k, @Context HttpServletRequest req) {
		...
		Kupac noviKupac = new Kupac(k);
		
		korisnici.dodajKorisnik(noviKupac);
		korisnici.sacuvajKorisnika();
		
		req.getSession().setAttribute("korisnik", noviKupac);
		System.out.println("Ulogovani korisnik: " + noviKupac);
